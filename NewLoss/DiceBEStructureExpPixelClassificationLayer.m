classdef DiceBEStructureExpPixelClassificationLayer < nnet.layer.ClassificationLayer
    ...
    methods
        function layer = DiceBEStructureExpPixelClassificationLayer(name,lambda1,lambda2,lambdaD,lambdaC,wD,wC)
            %Set layer name
            layer.Name = name;
        ...
        function loss = forwardLoss(layer,Y,T)
            ...
            loss = lossExp + layer.Lambda1*lossD + layer.Lambda2*lossBE + lossStructure; 
        end
    end
end
