classdef SensSpecDiceBEStructurePixelClassificationLayer < nnet.layer.ClassificationLayer
    ...
    methods
        function layer = SensSpecDiceBEStructurePixelClassificationLayer(name,lambda1,lambda2,r)
            %Set layer name
            layer.Name = name;
        ...
        function loss = forwardLoss(layer,Y,T)
            ...
            loss = lossD + layer.Lambda2*lossBE + 0.5*lossStructure + lossSens;            
        end
    end
end
